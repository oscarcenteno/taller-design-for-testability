...
#End ExternalSource
        ...
        Public Overridable Sub TestInitialize()
            If ((Not (TechTalk.SpecFlow.FeatureContext.Current) Is Nothing)  _
                ...
                LogicaDeAplicacion.UnitTests.ConfirmarPago.CasoBasicoAlConfirmarUnPagoFeature.FeatureSetup(Nothing)
            End If
        End Sub
...
#End ExternalSource
#ExternalSource("Caso basico al confirmar un pago.feature",25)
...
#End ExternalSource
            ...
            table3.AddRow(New String() {"Fecha de Confirmacion", "2015-06-01 12:00 PM"})
#ExternalSource("Caso basico al confirmar un pago.feature",27)
testRunner.Then("se generara esta confirmacion a la entidad destino", CType(Nothing,String), table3, "Entonces ")
#End ExternalSource
            ...
            table4.AddRow(New String() {"Codigo de Entidad Origen", "401"})
            table4.AddRow(New String() {"Codigo de Entidad Destino", "501"})
            table4.AddRow(New String() {"Numero de Telefono Destino", "60607070"})
            table4.AddRow(New String() {"Codigo de Moneda Destino", "1"})
            table4.AddRow(New String() {"Fecha Valor", "2015-06-01 11:59 AM"})
            table4.AddRow(New String() {"Fecha de Confirmacion", "2015-06-01 12:00 PM"})
#ExternalSource("Caso basico al confirmar un pago.feature",36)
testRunner.And("se actualizara la informacion de la transaccion", CType(Nothing,String), table4, "Y ")
#End ExternalSource
#ExternalSource("Caso basico al confirmar un pago.feature",48)
testRunner.And("se escribirá en bitacora que la transaccion fue confirmada", CType(Nothing,String), CType(Nothing,TechTalk.SpecFlow.Table), "Y ")
#End ExternalSource
            Me.ScenarioCleanup
        End Sub
    End Class
