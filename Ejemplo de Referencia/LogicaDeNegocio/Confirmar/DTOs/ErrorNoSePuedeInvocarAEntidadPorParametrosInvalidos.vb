Public Class ErrorNoSePuedeInvocarAEntidadPorParametrosInvalidos
    ...
    Public Sub New(transaccion As TransaccionDTO)
        _codReferencia = transaccion.CodigoDeReferencia
        _codEntidad = transaccion.CodigoDeEntidadDestino
    End Sub

    Public Overrides Function ToString() As String
        Return String.Format("No se confirmó la transacción {0} pues los parametros requeridos para invocar a la entidad {1} no están configurados", _codReferencia, _codEntidad)
    End Function
